...
(function ($) {
    ...
    function lightbox() {
        $('.lightbox').magnificPopup({
            ...
            gallery:{
                enabled:true,
                arrowMarkup: '<button title="%title%" type="button" class="mfp-arrow mfp-arrow-%dir%"><img src="https://img.icons8.com/material-outlined/24/FFFFFF/double-left.png"></button>',
            },
